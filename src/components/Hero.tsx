    ...
    return (
        <section className="mb-20 md:mb-28 pt-8 md:pt-16" aria-labelledby="hero-heading">
            ...
            >
                ...
                {/* Spotify Section */}
                <a 
                    href="https://open.spotify.com/track/3AJwUDP919kvQ9QcozQPxg"
                    target="_blank"
                ...
                >
                    ...
                    <span className="font-medium shrink-0 group-hover:text-md-on-background transition-colors">Last played</span>
                    <span className="opacity-50">—</span>
                    <span className="truncate max-w-[200px] sm:max-w-xs group-hover:text-md-on-background transition-colors">Yellow • Coldplay</span>
                </a>
